...
/**
 已经选择图片数
 */
@property (nonatomic, assign) NSInteger selectedAddPhotos;
/**
 已经选择视频数
 */
@property (nonatomic, assign) NSInteger selectedAddVideos;

/**
 最大允许选择图片数，默认为0时，无限制
 */
@property (nonatomic, assign) NSInteger maxCanSelectPhotos;
/**
 最大允许选择视频数，默认为0时，无限制
 */
@property (nonatomic, assign) NSInteger maxCanSelectVideos;
