...
- (void)selectPhotoButtonClick:(UIButton *)sender {
    ...
    self.coverView.hidden = !sender.isSelected;
}
...
- (UIButton *)selectPhotoButton {
    if (_selectPhotoButton == nil) {
        ...
        [self bringSubviewToFront:_selectPhotoButton];
    }
...
- (UIView *)coverView {
    if (!_coverView) {
        ...
        _coverView.layer.borderColor = [UIColor colorWithRed:105/255.0 green:191/255.0 blue:48/255.0 alpha:1.0].CGColor;
        _coverView.layer.borderWidth = 2.0f;
        _coverView.layer.masksToBounds = true;
        _coverView.userInteractionEnabled = false;
    }
    return _coverView;
}
...
- (void)layoutSubviews {
    ...
    _selectPhotoButton.frame = CGRectMake(self.tz_width - 36, 0, 36, 36);
    ...
    self.coverView.frame = CGRectMake(0, 0, self.tz_width, self.tz_height);
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _imageView.backgroundColor = [UIColor colorWithRed:237/255.0 green:234/255.0 blue:232/255.0 alpha:1/1.0];
...
- (void)layoutSubviews {
    [super layoutSubviews];
    _imageView.frame = CGRectMake((CGRectGetWidth(self.frame) - 36) / 2, (CGRectGetHeight(self.frame) - 36) / 2, 36, 36);
}
