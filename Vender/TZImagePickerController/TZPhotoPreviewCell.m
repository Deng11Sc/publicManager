...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        self.backgroundColor = kUIColorFromRGB(0xEDEAE8);;
        [self configSubviews];
...
- (void)configSubviews {
    ...
    self.coverView.layer.borderColor = [UIColor colorWithRed:105/255.0 green:191/255.0 blue:48/255.0 alpha:1.0].CGColor;
